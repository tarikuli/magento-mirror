	...
	function _qsJnit(){
		...
		qsHandlerImg.fancybox({
				...
				beforeShow : function(){
			        ...
			        quickview.find(".product-image-thumbs").bxSlider({infiniteLoop: true ,pager:false, minSlides: 3, visibleItems: 3, maxSlides: 3, slideMargin: 20, slideWidth: 100, responsiveBreakpoints : {480: 3, 640: 4, 768: 3, 900: 3}});
