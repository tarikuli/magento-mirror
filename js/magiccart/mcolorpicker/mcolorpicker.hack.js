...
//jQuery(function($){
	function getDirMcolorpicker () {
			...
			var dir = detected!==false ? detected : BLANK_URL.substr(0, BLANK_URL.length - 10) + 'magiccart/mcolorpicker/';
		return dir;
	}
...
// Add by DVN
jQuery( document ).ready(function($) {
	$(".color").attr("data-hex", true).width("116px").mColorPicker(); //$(".color").mColorPicker();
  	jQuery(document).on({ 
