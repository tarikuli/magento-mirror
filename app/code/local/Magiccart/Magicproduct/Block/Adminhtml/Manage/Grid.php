...
class Magiccart_Magicproduct_Block_Adminhtml_Manage_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareMassaction()
	{
		...
		$statuses = Mage::getSingleton('magicproduct/status')->getOptionArray();
