...
?>
<?php
class Magiccart_Megashop_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    protected $featured = Magiccart_Megashop_Helper_Data::FEATURED;
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('image',
            array(
                ...
                'type' => 'image',
                'renderer'  => 'megashop/adminhtml_renderer_grid_column_images',
                'width' => 64,
                'index' => 'image',
        ));
...
';
    ...
    //          'label'=> Mage::helper('megashop')->__('Change status'),
    ...
    //                      'label' => Mage::helper('megashop')->__('Status'),
    //                      'values' => $statuses
    //                  )
    //          )
    //     ));
