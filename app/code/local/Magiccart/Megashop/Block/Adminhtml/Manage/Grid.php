...
class Magiccart_Megashop_Block_Adminhtml_Manage_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareCollection()
	{
		$collection = Mage::getModel('core/config_data')->getCollection()
							->addFieldToFilter('path', array('like' => 'megashop/identifier/%'));
		if($collection){
	...
	protected function _prepareMassaction()
	{
		...
		$this->getMassactionBlock()->setFormFieldName('megashop');
		...
		$statuses = Mage::getSingleton('megashop/status')->getOptionArray();
