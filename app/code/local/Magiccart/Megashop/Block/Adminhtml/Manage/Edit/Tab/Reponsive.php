...
?>
<?php
class Magiccart_Megashop_Block_Adminhtml_Manage_Edit_Tab_Reponsive extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$this->setForm($form);
		$fieldset = $form->addFieldset('reponsive_form', array('legend'=>Mage::helper('megashop')->__('General Information')));
        ...
        $fieldset->addField('portrait', 'select', array(
            ...
            'values'	=> Mage::getSingleton('megashop/system_config_column')->toOptionArray(),
            'value'     => array(1),
        ));
