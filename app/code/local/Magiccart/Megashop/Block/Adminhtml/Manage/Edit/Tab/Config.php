...
?>
<?php
class Magiccart_Megashop_Block_Adminhtml_Manage_Edit_Tab_Config extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$this->setForm($form);
		$fieldset = $form->addFieldset('config_form', array('legend'=>Mage::helper('megashop')->__('General Information')));
		...
		$row = $fieldset->addField('row', 'select', array(
			...
			'name'      => 'row',
			'values'	=> Mage::getSingleton('megashop/system_config_row')->toOptionArray(),
			'value'     => array(1),
		));
        ...
        $fieldset->addField('action', 'multiselect', array(
            ...
            'values'	=> Mage::getSingleton('megashop/system_config_action')->toOptionArray(),
