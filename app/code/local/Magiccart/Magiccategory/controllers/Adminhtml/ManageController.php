 ...
 * @@Modify Date: 2015-12-16 21:42:02
 * @@Function:
 */
...
class Magiccart_Magiccategory_Adminhtml_ManageController extends Mage_Adminhtml_Controller_Action
{
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($data['magiccategory_tabs']['images']) && !empty($data['magiccategory_tabs']['images'])){	
				$images = Mage::helper('core')->jsonDecode($data['magiccategory_tabs']['images'],true);
				//$images = json_decode($data['magiccategory_tabs']['images'],true);
				$newArray = array();
				...
				$data['magiccategory_tabs']['images'] = $content;
			}
