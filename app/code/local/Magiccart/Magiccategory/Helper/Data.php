 ...
 * @@Modify Date: 2015-07-31 15:30:08
 * @@Function:
 */
?>
<?php
class Magiccart_Magiccategory_Helper_Data extends Mage_Core_Helper_Abstract
{

    const SECTIONS      = 'magiccategory';   // module name
    ...
    {
        return Mage::getBaseUrl('media') . 'magiccart/magiccategory/';
    }
    
    public function getBaseTmpMediaPath()
    {
        return Mage::getBaseDir('media') .DS. 'magiccart' .DS. 'magiccategory' .DS;
    }
