...
?>
<?php
class Magiccart_Magiccategory_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    protected $featured = Magiccart_Magiccategory_Helper_Data::FEATURED;
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('image',
            array(
                ...
                'type' => 'image',
                'renderer'  => 'magiccategory/adminhtml_renderer_grid_column_images',
                'width' => 64,
                'index' => 'image',
        ));
...
';
    ...
    //          'label'=> Mage::helper('magiccategory')->__('Change status'),
    ...
    //                      'label' => Mage::helper('magiccategory')->__('Status'),
    //                      'values' => $statuses
    //                  )
    //          )
    //     ));
